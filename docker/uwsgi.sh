...
# Configure uwsgi.
cp /ls_build/docker/services/uwsgi.ini /var/www/circulation/uwsgi.ini
...
cp /ls_build/docker/services/simplified_user.runit /etc/service/runsvdir-simplified/run

# Prepare uwsgi for runit.
app_home=/home/simplified
mkdir -p $app_home/service/uwsgi
cp /ls_build/docker/services/uwsgi.runit $app_home/service/uwsgi/run
