...
from palace.core.model.hybrid import hybrid_property
...
if TYPE_CHECKING:
    ...
    from palace.core.configuration.ignored_identifier import (  # noqa: autoflake
        IgnoredIdentifierConfiguration,
    )
    from palace.core.model import Collection  # noqa: autoflake
