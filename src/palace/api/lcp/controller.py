...
from palace.api.admin.problem_details import MISSING_COLLECTION
...
from palace.core.model import Collection, ExternalIntegration, Session
...
class LCPController(CirculationManagerController):
    ...
    def _get_patron(self):
        ...
        :rtype: palace.core.model.patron.Patron
        """
        self._logger.info(
    ...
    def _get_lcp_collection(self, patron, collection_name):
        ...
        :type patron: palace.core.model.patron.Patron

        :param collection_name: Name of the collection
        :type collection_name: string

        :return: LCP collection
        :rtype: palace.core.model.collection.Collection
        """
        db = Session.object_session(patron)
