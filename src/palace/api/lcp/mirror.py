...
from palace.api.lcp.encrypt import LCPEncryptor
...
from palace.core.model import Collection, ExternalIntegration
...
class LCPMirror(MinIOUploader, HasExternalIntegrationPerCollection):
    ...
    def collection_external_integration(self, collection):
        ...
        :type collection: palace.core.model.Collection

        :return: External integration associated with the collection
        :rtype: palace.core.model.configuration.ExternalIntegration
        """
