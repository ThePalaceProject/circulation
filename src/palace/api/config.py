...
from palace.core.config import CannotLoadConfiguration  # noqa: autoflake
from palace.core.config import IntegrationException  # noqa: autoflake
from palace.core.config import Configuration as CoreConfiguration
from palace.core.config import empty_config as core_empty_config
from palace.core.config import temp_config as core_temp_config
...
# class from palace.core still has the old value. Change that one to match,
