...
from palace.api.admin.config import Configuration as AdminClientConfig
...
from palace.api.admin.template_styles import *
from palace.api.admin.templates import admin as admin_template
...
from palace.api.axis import Axis360API
from palace.api.bibliotheca import BibliothecaAPI
from palace.api.config import CannotLoadConfiguration, Configuration
from palace.api.controller import CirculationManagerController
from palace.api.enki import EnkiAPI
from palace.api.feedbooks import FeedbooksOPDSImporter
...
from palace.api.odilo import OdiloAPI
from palace.api.odl import ODLAPI, SharedODLAPI
from palace.api.odl2 import ODL2API
from palace.api.opds_for_distributors import OPDSForDistributorsAPI
from palace.api.overdrive import OverdriveAPI
from palace.core.app_server import load_pagination_from_request
...
from palace.core.model.classification import Classification, Genre, Subject
...
from palace.core.opds2_import import OPDS2Importer
...
from palace.core.util.cache import memoize
from palace.core.util.datetime_helpers import utc_now
from palace.core.util.flask_util import OPDSFeedResponse, boolean_value
...
def setup_admin_controllers(manager):
    ...
    from palace.api.admin.controller.work_editor import WorkController
    ...
    from palace.api.admin.controller.discovery_services import (
        DiscoveryServicesController,
    )

    manager.admin_discovery_services_controller = DiscoveryServicesController(manager)
    from palace.api.admin.controller.discovery_service_library_registrations import (
    ...
    from palace.api.admin.controller.analytics_services import (
        AnalyticsServicesController,
    )
    ...
    from palace.api.admin.controller.metadata_service_self_tests import (
    ...
    from palace.api.admin.controller.patron_auth_service_self_tests import (
    ...
    from palace.api.admin.controller.admin_auth_services import (
        AdminAuthServicesController,
    )

    manager.admin_auth_services_controller = AdminAuthServicesController(manager)
    from palace.api.admin.controller.collection_settings import (
        CollectionSettingsController,
    )

    manager.admin_collection_settings_controller = CollectionSettingsController(manager)
    from palace.api.admin.controller.collection_self_tests import (
    ...
    from palace.api.admin.controller.collection_library_registrations import (
    ...
    from palace.api.admin.controller.sitewide_settings import (
    ...
    from palace.api.admin.controller.individual_admin_settings import (
    ...
    from palace.api.admin.controller.search_service_self_tests import (
    ...
    from palace.api.admin.controller.catalog_services import CatalogServicesController
