...
from palace.api.saml.configuration.model import SAMLOneLoginConfiguration
...
class SAMLAuthenticationManager:
    ...
    def _filter_subject(self, subject):
        ...
        :rtype: Union[api.saml.metadata.model.SAMLSubject, palace.core.util.problem_detail.ProblemDetail]
        """
