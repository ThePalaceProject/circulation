...
from palace.api.saml.metadata.model import SAMLSubjectPatronIDExtractor
from palace.api.saml.metadata.parser import SAMLMetadataParser, SAMLMetadataParsingError
...
class SAMLSettingsValidator(Validator):
    ...
    def _get_setting_value(
        ...
        :rtype: Union[str, palace.core.util.problem_detail.ProblemDetail]
        """
    ...
    def _parse_metadata(self, xml_metadata, provider_type):
        ...
        :rtype: Union[List[api.saml.metadata.model.SAMLProviderMetadata], palace.core.util.problem_detail.ProblemDetail]
        """
        try:
    ...
    def _process_sp_providers(self, settings, content, setting_key, setting_name):
        ...
        :rtype: Union[api.saml.metadata.model.SAMLServiceProviderMetadata, palace.core.util.problem_detail.ProblemDetail]
        """
    ...
    def _process_idp_providers(self, settings, content, setting_key, setting_name):
        ...
        :rtype: Union[
            ...
            palace.core.util.problem_detail.ProblemDetail
        ]
        """
