...
from palace.core.util.datetime_helpers import to_utc
...
class ONIXExtractor:
    ...
    def parse(cls, file, data_source_name, default_medium=None):
        ...
        for record in root.findall("product"):
            ...
            language = (
                parser.text_of_optional_subtag(
                    record, "descriptivedetail/language/b252"
                )
                or "eng"
            )
            ...
            if publishing_date:
                ...
                if issued.tzinfo is None:
                    cls._logger.warning(
                        "Publishing date {} does not contain timezone information. Assuming UTC.".format(
                            publishing_date
                        )
                    )
            ...
            for tag in subject_tags:
                ...
                if type in cls.SUBJECT_TYPES:
                    ...
                    if b069:
                        subjects.append(
                            SubjectData(cls.SUBJECT_TYPES[type], b069, weight=weight)
                        )
            ...
            for usage_constraint_tag in usage_constraint_tags:
                ...
                if usage_status == UsageStatus.PROHIBITED.value:
                    ...
                    usage_limit_tags = parser._xpath(
                        record, "descriptivedetail/epubusageconstraint/epubusagelimit"
                    )
                    ...
                    if (
                        ...
                        or usage_status == UsageUnit.CONCURRENT_USERS.value
                    ):
