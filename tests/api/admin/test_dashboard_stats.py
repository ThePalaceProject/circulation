...
class TestDashboardStatistics(DatabaseTest):
    def test_stats_patrons(self, admin: Admin, db: DatabaseTransactionFixture):
    ...
    def test_stats_inventory(self, admin: Admin, db: DatabaseTransactionFixture):
        db_session = db.session
    ...
    def test_stats_collections(self, admin: Admin, db: DatabaseTransactionFixture):
        db_session = db.session
    ...
    def test_stats_parent_collection_permissions(
        self, admin: Admin, db: DatabaseTransactionFixture
    ):
