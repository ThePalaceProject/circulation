...
class TestWork:
    def test_all_identifier_ids(self, database_transaction: DatabaseTransactionFixture):
        ...
        lp2 = database_transaction.licensepool(None)
    ...
    def test_from_identifiers(self, database_transaction: DatabaseTransactionFixture):
        session = database_transaction.session()
        ...
        lp = work.license_pools[0]
        ignored_work = database_transaction.work(
            with_license_pool=True, with_open_access_download=True
        )
        ...
        isbn = database_transaction.identifier(Identifier.ISBN)
    ...
    def test_calculate_presentation(
        ...
        edition1, pool1 = database_transaction.edition(
            gitenberg_source,
        ...
        edition2, pool2 = database_transaction.edition(
            gitenberg_source,
            Identifier.GUTENBERG_ID,
            with_license_pool=True,
            with_open_access_download=True,
        ...
        edition3, pool3 = database_transaction.edition(
            gutenberg_source,
            Identifier.GUTENBERG_ID,
            with_license_pool=True,
            with_open_access_download=True,
        ...
        # won't be chosen.
        related_identifier = database_transaction.identifier()
        ...
        work = database_transaction.slow_work(presentation_edition=edition2)
        ...
        staff_edition = database_transaction.edition(
    ...
    def test_calculate_presentation_uses_default_audience_set_as_collection_setting(
        ...
        edition, pool = database_transaction.edition(
        ...
        work = database_transaction.slow_work(presentation_edition=edition)
        work.last_update_time = None
        work.presentation_ready = True
    ...
    def test__choose_summary(self, database_transaction: DatabaseTransactionFixture):
        session = database_transaction.session()
    ...
    def test_assign_genres_from_weights(
        self, database_transaction: DatabaseTransactionFixture
    ):
        session = database_transaction.session()
    ...
    def test_classifications_with_genre(
        ...
        subject1 = database_transaction.subject(type="type1", identifier="subject1")
        subject1.genre = genres[0]
        subject2 = database_transaction.subject(type="type2", identifier="subject2")
        subject2.genre = genres[1]
        subject3 = database_transaction.subject(type="type2", identifier="subject3")
        subject3.genre = None
        source = DataSource.lookup(session, DataSource.AXIS_360)
        classification1 = database_transaction.classification(
            identifier=identifier, subject=subject1, data_source=source, weight=1
        )
        classification2 = database_transaction.classification(
            identifier=identifier, subject=subject2, data_source=source, weight=2
        )
        classification3 = database_transaction.classification(
    ...
    def test_mark_licensepools_as_superceded(
        ...
        # un-superceded.
        commercial = database_transaction.licensepool(
        ...
        # chosen.
        gutenberg = database_transaction.licensepool(
            None,
        ...
        standard_ebooks = database_transaction.licensepool(
            None,
        ...
        gitenberg1 = database_transaction.licensepool(
            edition=None,
            open_access=True,
        ...
        gitenberg2 = database_transaction.licensepool(
            edition=None,
            open_access=True,
            data_source_name=DataSource.PROJECT_GITENBERG,
            with_open_access_download=True,
        ...
        gutenberg1 = database_transaction.licensepool(
            edition=None,
            open_access=True,
            data_source_name=DataSource.GUTENBERG,
            with_open_access_download=True,
        ...
        work_multipool = database_transaction.work(presentation_edition=None)
        ...
        only_pool = database_transaction.licensepool(
    ...
    def test_work_remains_viable_on_pools_suppressed(
        ...
        (
            ...
            alice,
            bob,
        ) = database_transaction.sample_ecosystem()
    ...
    def test_work_updates_info_on_pool_suppressed(
        self, database_transaction: DatabaseTransactionFixture
    ):
        session = database_transaction.session()
    ...
    def test_different_language_means_different_work(
        ...
        title = "Siddhartha"
        author = ["Herman Hesse"]
        edition1, lp1 = database_transaction.edition(
            title=title,
            authors=author,
            language="eng",
            with_license_pool=True,
        ...
        edition2, lp2 = database_transaction.edition(
            title=title,
            authors=author,
            language="ger",
            with_license_pool=True,
    ...
    def test_reject_covers(
        ...
        edition, lp = database_transaction.edition(with_open_access_download=True)
        ...
        thumbnail_rep = database_transaction.representation(
            url=thumbnail_href,
            media_type=Representation.PNG_MEDIA_TYPE,
            content=open(sample_cover_path, "rb").read(),
            mirrored=True,
        ...
        work = database_transaction.work(presentation_edition=edition)
        ...
        other_work_ed = database_transaction.edition()
        other_work_ed.set_cover(cover_link.resource)
        other_work = database_transaction.work(presentation_edition=other_work_ed)
    ...
    def test_missing_coverage_from_sorts_results(
        self, database_transaction: DatabaseTransactionFixture
    ):
        session = database_transaction.session()
        ...
        work1 = database_transaction.work(with_license_pool=True)
        work2 = database_transaction.work(with_license_pool=True)
        works = [work1, work2]
    ...
    def test_top_genre(self, database_transaction: DatabaseTransactionFixture):
        session = database_transaction.session()
    ...
    def test_to_search_document(self, database_transaction: DatabaseTransactionFixture):
        session = database_transaction.session()

        # Set up an edition and work.
        edition, pool1 = database_transaction.edition(
            authors=[
        ...
        database_transaction.default_library().collections.append(collection2)
        pool2 = database_transaction.licensepool(
            edition=edition, collection=collection2
        )
        ...
        # doing anything.
        collection3 = database_transaction.collection()
        ...
        contributor1.display_name = database_transaction.fresh_str()
        contributor1.family_name = database_transaction.fresh_str()
        contributor1.viaf = database_transaction.fresh_str()
        contributor1.lc = database_transaction.fresh_str()
        [contributor2] = [
            c.contributor
            for c in edition.contributions
        ...
        identifier1 = database_transaction.identifier(identifier_type=Identifier.ISBN)
        ...
        identifier2 = database_transaction.identifier(identifier_type=Identifier.ISBN)
        identifier2.equivalent_to(data_source, identifier2, 0.1)

        # This identifier is equivalent to the _edition's_, but too weak to
        # be used.
        identifier3 = database_transaction.identifier(identifier_type=Identifier.ISBN)
        ...
        identifier1.classify(
            data_source, Subject.DDC, database_transaction.fresh_str(), None
        )

        # These classifications will be left out because their identifiers aren't sufficiently equivalent to the edition's.
        identifier2.classify(
            data_source, Subject.FAST, database_transaction.fresh_str(), None
        )
        identifier3.classify(
            data_source, Subject.FAST, database_transaction.fresh_str(), None
        )
        ...
        l1, ignore = database_transaction.customlist(num_entries=0)
        l1.add_entry(
            work,
            featured=False,
        ...
        l2, ignore = database_transaction.customlist(num_entries=0)
        l2.add_entry(
            work,
            featured=True,
            update_external_index=False,
        ...
        edition.subtitle = database_transaction.fresh_str()
        edition.series = database_transaction.fresh_str()
        edition.series_position = 99
        edition.publisher = database_transaction.fresh_str()
        edition.imprint = database_transaction.fresh_str()
        work.fiction = False
        work.audience = Classifier.AUDIENCE_YOUNG_ADULT
        work.summary_text = database_transaction.fresh_str()
        work.rating = 5
        work.popularity = 4
    ...
    def test_to_search_doc_no_edition(
        self, database_transaction: DatabaseTransactionFixture
    ):
    ...
    def test_to_search_doc_datetime_cases(
        self, database_transaction: DatabaseTransactionFixture
    ):
    ...
    def test_age_appropriate_for_patron(
        self, database_transaction: DatabaseTransactionFixture
    ):
        work = database_transaction.work()
        work.audience = Classifier.AUDIENCE_YOUNG_ADULT
    ...
    def test_target_age_string(self, database_transaction: DatabaseTransactionFixture):
        work = database_transaction.work()
        work.target_age = NumericRange(7, 8, "[]")
    ...
    def test_reindex_on_availability_change(
        ...
        # as needing it.)
        no_licensepool = database_transaction.work()
        ...
        record.status = success
        another_work = database_transaction.work(with_license_pool=True)
    ...
    def test_reset_coverage(self, database_transaction: DatabaseTransactionFixture):
    ...
    def test_for_unchecked_subjects(
        self, database_transaction: DatabaseTransactionFixture
    ):
        session = database_transaction.session()

        w1 = database_transaction.work(with_license_pool=True)
    ...
    def test_calculate_opds_entries(
        self, database_transaction: DatabaseTransactionFixture
    ):
    ...
    def test_calculate_marc_record(
        self, database_transaction: DatabaseTransactionFixture
    ):
        work = database_transaction.work(with_license_pool=True)
    ...
    def test_active_licensepool_ignores_superceded_licensepools(
        ...
        edition, pool2 = database_transaction.edition(with_license_pool=True)
        work.license_pools.append(pool2)
    ...
    def test_active_license_pool_accounts_for_library(
        ...
        l1.collections = [c1]
        l2.collections = [c2]
        work: Work = database_transaction.work(
            presentation_edition=database_transaction.edition()
        )
        lp1: LicensePool = database_transaction.licensepool(
            work.presentation_edition,
            collection=c1,
            unlimited_access=True,
        )
        lp2 = database_transaction.licensepool(
            work.presentation_edition,
            collection=c2,
            unlimited_access=True,
            open_access=False,
    ...
    def test_delete_work(self, database_transaction: DatabaseTransactionFixture):
        session = database_transaction.session()
...
class TestWorkConsolidation:
    def test_calculate_work_success(
        self, database_transaction: DatabaseTransactionFixture
    ):
        e, p = database_transaction.edition(with_license_pool=True)
        work, new = p.calculate_work()
        assert p.presentation_edition == work.presentation_edition
        assert True == new

    def test_calculate_work_bails_out_if_no_title(
        self, database_transaction: DatabaseTransactionFixture
    ):
        e, p = database_transaction.edition(with_license_pool=True)
        e.title = None
    ...
    def test_calculate_work_even_if_no_author(
        self, database_transaction: DatabaseTransactionFixture
    ):
        title = "Book"
        e, p = database_transaction.edition(
            with_license_pool=True, authors=[], title=title
        )
        work, new = p.calculate_work()
    ...
    def test_calculate_work_matches_based_on_permanent_work_id(
        ...
        edition1, ignore = database_transaction.edition(with_license_pool=True)
        edition2, ignore = database_transaction.edition(
    ...
    def test_calculate_work_for_licensepool_creates_new_work(
        ...
        edition1, ignore = database_transaction.edition(
            data_source_name=DataSource.GUTENBERG,
            identifier_type=Identifier.GUTENBERG_ID,
            title=database_transaction.fresh_str(),
            authors=[database_transaction.fresh_str()],
            with_license_pool=True,
        )
        ...
        edition2, pool = database_transaction.edition(
            data_source_name=DataSource.GUTENBERG,
            identifier_type=Identifier.GUTENBERG_ID,
            title=database_transaction.fresh_str(),
            authors=[database_transaction.fresh_str()],
    ...
    def test_calculate_work_fails_when_presentation_edition_identifier_does_not_match_license_pool(
        ...
        edition1, pool = database_transaction.edition(
    ...
    def test_open_access_pools_grouped_together(
        self, database_transaction: DatabaseTransactionFixture
    ):
        session = database_transaction.session()
        ...
        ed1, open1 = database_transaction.edition(
            title=title, authors=author, with_license_pool=True
        )
        ed2, open2 = database_transaction.edition(
            title=title, authors=author, with_license_pool=True
        )
        open1.open_access = True
        open2.open_access = True
        ed3, restricted3 = database_transaction.edition(
            title=title,
            authors=author,
            data_source_name=DataSource.OVERDRIVE,
            with_license_pool=True,
        )
        ed4, restricted4 = database_transaction.edition(
            title=title,
            authors=author,
            data_source_name=DataSource.OVERDRIVE,
            with_license_pool=True,
    ...
    def test_all_licensepools_with_same_identifier_get_same_work(
        ...
        edition1, pool1 = database_transaction.edition(with_license_pool=True)
        ...
        assert database_transaction.default_collection() == pool1.collection
    ...
    def test_calculate_work_fixes_work_in_invalid_state(
        ...
        edition, abcd_commercial_2 = database_transaction.edition(
            with_license_pool=True
        )
        ...
        edition, abcd_open_access = database_transaction.edition(
            with_license_pool=True, with_open_access_download=True
        )
    ...
    def test_calculate_work_fixes_incorrectly_grouped_books(
        ...
        edition, audiobook = database_transaction.edition(with_license_pool=True)
        ...
        edition, spanish = database_transaction.edition(with_license_pool=True)
    ...
    def test_calculate_work_detaches_licensepool_with_no_pwid(
        ...
        edition, no_title = database_transaction.edition(with_license_pool=True)
    ...
    def test_pwids(self, database_transaction: DatabaseTransactionFixture):
        ...
        edition, lp2 = database_transaction.edition(with_license_pool=True)
        work.license_pools.append(lp2)
    ...
    def test_open_access_for_permanent_work_id(
        self, database_transaction: DatabaseTransactionFixture
    ):
        session = database_transaction.session()
        ...
        edition, lp3 = database_transaction.edition(
            with_license_pool=True, with_open_access_download=True
        )
        ...
        # for that book.
        w3 = database_transaction.work(with_license_pool=True)
    ...
    def test_open_access_for_permanent_work_id_can_create_work(
        ...
        edition, lp = database_transaction.edition(with_license_pool=True)
        lp.open_access = True
    ...
    def test_potential_open_access_works_for_permanent_work_id(
        ...
        title = "Siddhartha"
        author = ["Herman Hesse"]
        e1, lp1 = database_transaction.edition(
            data_source_name=DataSource.STANDARD_EBOOKS,
            title=title,
            authors=author,
            language="eng",
        ...
        e2, lp2 = database_transaction.edition(
            data_source_name=DataSource.GUTENBERG,
            title=title,
            authors=author,
            language="eng",
        ...
        bad_pe = database_transaction.edition()
    ...
    def test_make_exclusive_open_access_for_permanent_work_id(
        ...
        # literary work "abcd".
        work1 = database_transaction.work(
            with_license_pool=True, with_open_access_download=True
        )
        ...
        edition, abcd_commercial = database_transaction.edition(
            with_license_pool=True, with_open_access_download=True
        )
        abcd_commercial.open_access = False
        abcd_commercial.presentation_edition.permanent_work_id = "abcd"
        ...
        work2 = database_transaction.work(
            with_license_pool=True, with_open_access_download=True
        )
        ...
        # work.
        edition, efgh_2 = database_transaction.edition(
            with_license_pool=True, with_open_access_download=True
        )
    ...
    def test_make_exclusive_open_access_for_null_permanent_work_id(
        ...
        edition, null2 = database_transaction.edition(
            with_license_pool=True, with_open_access_download=True
        )
    ...
    def test_merge_into_success(self, database_transaction: DatabaseTransactionFixture):
        session = database_transaction.session()
    ...
    def test_open_access_for_permanent_work_id_fixes_mismatched_works_incidentally(
        ...
        edition, abcd_2 = database_transaction.edition(
            with_license_pool=True, with_open_access_download=True
        )
        ...
        edition, efgh = database_transaction.edition(
            with_license_pool=True, with_open_access_download=True
        )
        ...
        edition, ijkl = database_transaction.edition(
            with_license_pool=True, with_open_access_download=True
        )
    ...
    def test_open_access_for_permanent_work_untangles_tangled_works(
        ...
        abcd_work = database_transaction.work(
            with_license_pool=True, with_open_access_download=True
        )
        [abcd_1] = abcd_work.license_pools

        efgh_work = database_transaction.work(
            with_license_pool=True, with_open_access_download=True
        )
        ...
        abcd_edition, abcd_2 = database_transaction.edition(
            with_license_pool=True, with_open_access_download=True
        )
        efgh_work.license_pools.append(abcd_2)

        efgh_edition, efgh_2 = database_transaction.edition(
            with_license_pool=True, with_open_access_download=True
        )
