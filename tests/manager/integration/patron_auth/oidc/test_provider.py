...
class TestOIDCAuthenticationProvider:
    ...
    def test_remote_patron_lookup_from_oidc_claims_with_filter_allowed(self):
        settings = OIDCAuthSettings(
            issuer_url="https://idp.example.com",
            client_id="test-client-id",
            client_secret="test-client-secret",
        ...
        id_token_claims = {"sub": "test-user", "role": "patron"}

        patron_data = provider.remote_patron_lookup_from_oidc_claims(id_token_claims)

        assert patron_data.permanent_id == "test-user"

    def test_remote_patron_lookup_from_oidc_claims_with_filter_denied(self):
        settings = OIDCAuthSettings(
            issuer_url="https://idp.example.com",
            client_id="test-client-id",
            client_secret="test-client-secret",
        ...
        id_token_claims = {"sub": "test-user", "role": "staff"}
