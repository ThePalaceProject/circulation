...
from palace.manager.celery.tasks.custom_list import (
...
class TestAutoUpdateCustomListJob:
    ...
    def test_init_backpopulates(
        ...
        with patch(
            "palace.manager.celery.tasks.custom_list.CustomListQueries"
        ) as mock_queries:
            AutoUpdateCustomListJob(
...
def test_update_custom_list(
    ...
    with patch(
        "palace.manager.celery.tasks.custom_list.AutoUpdateCustomListJob"
    ) as mock_job:
...
def test_update_custom_lists(
    ...
    with patch(
        "palace.manager.celery.tasks.custom_list.update_custom_list"
    ) as mock_update:
