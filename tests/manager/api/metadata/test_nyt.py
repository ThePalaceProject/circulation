...
class NYTFilesFixture(FilesFixture):
...
@pytest.fixture()
def nyt_files_fixture() -> NYTFilesFixture:
    """A fixture providing access to NYT files."""
...
def nyt_fixture(
    db: DatabaseTransactionFixture, nyt_files_fixture: NYTFilesFixture
) -> NYTBestSellerAPIFixture:
    return NYTBestSellerAPIFixture(db, nyt_files_fixture)
