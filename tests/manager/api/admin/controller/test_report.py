...
class TestReportController:
    ...
    def test_generate_report_authorization(
        ...
        def assert_and_clear_caplog(
            response: Response | ProblemDetail, email: str, success_message: str
        ) -> None:
            assert isinstance(response, Response)
        ...
        with flask_app_fixture.test_request_context(
            ...
            assert_and_clear_caplog(
                generate_report(), sysadmin_email, gen_report_success_message
            )
        ...
        with flask_app_fixture.test_request_context(
            ...
            assert_and_clear_caplog(
                generate_report(), librarian_email, gen_report_success_message
            )
