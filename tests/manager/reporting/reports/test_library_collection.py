...
class TestLibraryTitleLevelReport:

    def test_properties(self):
        report = LibraryTitleLevelReport(
        ...
        assert report.key == "title-level-report"
        assert report.title == "Title-Level Report"
        assert report.table_classes == [LibraryAllTitleReportTable]
