...
class TestManifest:
    ...
    def test_add_link(self):
        ...
        assert [{"href": "http://foo/", "rel": "self", "extra": "value"}] == dict[
            "links"
        ]
    ...
    def test_add_reading_order(self):
        ...
        manifest.add_reading_order(
            "http://foo/", "text/html", "Chapter 1", extra="value"
        )
        dict = manifest.as_dict
        assert [
            {
    ...
    def test_add_resource(self):
        ...
        dict = manifest.as_dict
        assert [{"href": "http://foo/", "type": "text/html", "extra": "value"}] == dict[
            "resources"
        ]
    ...
    def test_null_properties_not_propagated(self):
        ...
        manifest.add_reading_order(
            "http://foo/", "text/html", "Chapter 1", **additional_properties
        )
