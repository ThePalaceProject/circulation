...
def is_corporate_name(display_name):
    ...
    if (
        display_name.startswith("the ")
        or display_name.startswith("editor ")
        or display_name.startswith("editors ")
        or display_name.endswith(" inc")
        or display_name.endswith(" llc")
        or display_name.startswith("compiled")
    ):
        return True
    return False
...
def sort_name_to_display_name(sort_name):
    ...
    display_name = " ".join(
        [name.title, name.first, name.nickname, name.middle, name.last, name.suffix]
    )
