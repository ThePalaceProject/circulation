...
- `PALACE_BEARER_TOKEN_SIGNING_SECRET`: A secret key used for used to provide cryptographic signing, and should
   be set to a unique, unpredictable value, at least 24 characters long. Required when using SAML
